...
async function sendMessage(event){
    ...
    const response=await axios.post("http://51.20.172.55:4000/messages/sendMessage",obj,{headers :{"Authorization" :token}}) 
...
document.addEventListener('DOMContentLoaded',function () {
    ...
    async function allMessages(){
        try{
            ...
            const response=await axios.get(`http://51.20.172.55:4000/messages/allMessages/${messageee}`,{headers :{"Authorization" :token}}) 
